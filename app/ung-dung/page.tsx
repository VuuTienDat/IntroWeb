...
export const metadata: Metadata = {
  title: "Đăng nhập web app",
  description: "Cổng đăng nhập minh họa cho web app Bee System.",
  ...
  return (
    <main className="app-gateway">
      <section className="login-card" aria-labelledby="login-title">
        ...
        <h1 id="login-title">Đăng nhập web app</h1>
        <p>Tiếp tục bằng tài khoản Google của đơn vị để truy cập hệ thống nghiệp vụ Bee System.</p>
        <button type="button" className="google-button" disabled aria-describedby="demo-note">
          <GoogleMark /> Đăng nhập bằng Google
        </button>
        <div className="demo-note" id="demo-note">
          <LockKeyhole size={15} /> Đây là màn hình minh họa. Bản chính thức sẽ kết nối Google OAuth và tên miền web app riêng.
        </div>
        <Link href="/" className="text-link mt-6"><ArrowLeft size={16} /> Quay lại website</Link>
      </section>
    </main>
  );
}
