      ...
      <section className="hero">
        ...
        <div className="shell hero-layout">
          <div className="hero-copy">
            <div className="hero-kicker"><span className="pulse-dot" /> Công nghệ cho y tế và điều dưỡng</div>
            <h1>Phần mềm y tế <span>được thiết kế quanh người vận hành.</span></h1>
            <p className="hero-lead">
              Bee System Việt Nam phát triển giải pháp phần mềm cho y tế và điều dưỡng,
              giúp quy trình chăm sóc rõ hơn, dữ liệu dễ theo dõi hơn và đội ngũ vận hành nhẹ hơn.
            </p>
          ...
          <div className="hero-media care-board">
